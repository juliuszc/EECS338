...
//This function assigns the category to the information received from main.js
// and calculates the time and urls for each category.
...
var categoryData = function() {
    ...
    categories = {
        ...
        Streaming: new Category('Streaming'),
        Reading: new Category('Reading'),
    ...
    $.each(meta, function(i, elem){
        ...
        var category = categories[ALCHEMY_CATEGORY_MAP[elem['category']]];
